...
public final class UriUtil
{
    ...
    private static String removeDotSegments(final StringBuilder sb, int i, int n) {
        if (i >= n) {
            return sb.toString();
        }
        int n2 = i;
    ...
    public static String resolve(String s, final String s2) {
        ...
        if (uriIndices[1] != 0) {
            ...
            return removeDotSegments(sb, uriIndices[1] + n, uriIndices[2] + n);
        }
        ...
        return removeDotSegments(sb, uriIndices2[1], uriIndices[2] + n2);
    }
