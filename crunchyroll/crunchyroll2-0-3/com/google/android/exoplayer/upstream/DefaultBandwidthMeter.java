...
public final class DefaultBandwidthMeter implements BandwidthMeter
{
    ...
    public DefaultBandwidthMeter(final Handler handler, final EventListener eventListener) {
        this(handler, eventListener, new SystemClock());
    }
    
    public DefaultBandwidthMeter(final Handler handler, final EventListener eventListener, final Clock clock) {
        this(handler, eventListener, clock, 2000);
    }
    
    public DefaultBandwidthMeter(final Handler eventHandler, final EventListener eventListener, final Clock clock, final int n) {
    ...
    private void notifyBandwidthSample(final int n, final long n2, final long n3) {
        if (this.eventHandler != null && this.eventListener != null) {
            this.eventHandler.post((Runnable)new Runnable() {
                @Override
                public void run() {
                    DefaultBandwidthMeter.this.eventListener.onBandwidthSample(n, n2, n3);
                }
            });
        }
    }
