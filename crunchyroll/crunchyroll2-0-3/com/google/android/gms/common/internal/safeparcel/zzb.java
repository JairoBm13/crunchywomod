...
public class zzb
{
    ...
    public static void zza(final Parcel parcel, int zzF, final Parcel parcel2, final boolean b) {
        if (parcel2 == null) {
            if (b) {
                zzb(parcel, zzF, 0);
            }
    ...
    public static void zza(final Parcel parcel, int zzF, final int[] array, final boolean b) {
        if (array == null) {
            if (b) {
                zzb(parcel, zzF, 0);
            }
