...
public final class zzf
{
    ...
    static {
        zzUP = Pattern.compile("urn:x-cast:[-A-Za-z0-9_]+(\\.[-A-Za-z0-9_]+)*");
    }
    
    public static double zzA(final long n) {
        return n / 1000.0;
    }
    ...
    public static void zzbD(final String s) throws IllegalArgumentException {
    ...
    public static long zze(final double n) {
