...
import com.google.gson.internal.LinkedTreeMap$com.google.gson.internal.LinkedTreeMap$LinkedTreeMapIterator;
import java.util.Iterator;
import java.util.AbstractSet;
import java.util.Map;
import java.util.Set;
import com.google.gson.internal.LinkedTreeMap$com.google.gson.internal.LinkedTreeMap$KeySet;
import com.google.gson.internal.LinkedTreeMap$com.google.gson.internal.LinkedTreeMap$EntrySet;
...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable
{
    ...
    class EntrySet extends AbstractSet<Entry<K, V>>
    {
        ...
        public Iterator<Entry<K, V>> iterator() {
            return (Iterator<Entry<K, V>>)new LinkedTreeMap$LinkedTreeMapIterator<Entry<K, V>>() {
                public Entry<K, V> next() {
                    return (Entry<K, V>)this.nextNode();
                }
            };
        }
    ...
    class KeySet extends AbstractSet<K>
    {
        ...
        public Iterator<K> iterator() {
            return (Iterator<K>)new LinkedTreeMap$LinkedTreeMapIterator<K>() {
                public K next() {
