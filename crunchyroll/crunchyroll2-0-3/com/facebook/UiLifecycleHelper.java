        ...
        if (this.pendingFacebookDialogCallId != null) {
            ...
            if (pendingCallById != null) {
                if (callback != null) {
                    ...
                    FacebookDialog.handleActivityResult((Context)this.activity, pendingCallById, pendingCallById.getRequestCode(), intent, callback);
                }
        ...
        if (this.pendingFacebookDialogCallId != null) {
            ...
            if (pendingCallById != null && pendingCallById.getRequestCode() == n) {
                ...
                if (callIdFromIntent != null && this.pendingFacebookDialogCallId.equals(callIdFromIntent)) {
                    FacebookDialog.handleActivityResult((Context)this.activity, pendingCallById, n, intent, callback);
                }
                else {
                    this.cancelPendingAppCall(callback);
                }
