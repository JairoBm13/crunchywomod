...
public class FacebookWebFallbackDialog extends WebDialog
{
    ...
    public static boolean presentWebFallback(final Context context, final String s, final String s2, final FacebookDialog.PendingCall pendingCall, final FacebookDialog.Callback callback) {
        ...
        facebookWebFallbackDialog.setOnCompleteListener((OnCompleteListener)new OnCompleteListener() {
            @Override
