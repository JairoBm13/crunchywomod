...
public class AdsActivity extends Activity implements AdShower, AdTracker, TremorAdStateListener
{
    ...
    public static void start(final Activity activity, final AdRoll adRoll, final AdTrackListener adTrackListener, final int n, final DeepLinker deepLinker) {
        final Intent intent = new Intent((Context)activity, (Class)AdsActivity.class);
    ...
    public void adReady(final boolean b) {
        ...
        try {
            ...
            if (this.mTremorAppId != null) {
                b2 = TremorVideo.showAd(this, this.mTremorAppId, 4919);
            }
            else {
                b2 = TremorVideo.showAd(this, 4919);
            }
            if (!b2) {
                this.mAdHandler.onActivityResult(56026, 45243, null);
