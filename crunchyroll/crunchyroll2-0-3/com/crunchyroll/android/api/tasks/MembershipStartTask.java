...
public class MembershipStartTask extends BaseTask<Void>
{
    private final PaymentInformation mPaymentInformation;
    
    public MembershipStartTask(final Context context, final PaymentInformation mPaymentInformation) {
        super(context);
    ...
    public Void call() throws Exception {
        this.getApiService().run(new MembershipStartRequest(this.mPaymentInformation));
        return null;
    }
