...
public class b implements com.tremorvideo.sdk.android.videoad.a.a, l
{
    ...
    public b() {
        ...
        this.f = new BroadcastReceiver() {
            public void onReceive(final Context context, final Intent intent) {
                com.tremorvideo.sdk.android.a.b.this.c = false;
                com.tremorvideo.sdk.android.a.b.this.i.l();
            }
        };
        this.g = new BroadcastReceiver() {
            public void onReceive(final Context context, final Intent intent) {
                com.tremorvideo.sdk.android.a.b.this.c = true;
                com.tremorvideo.sdk.android.a.b.this.i.k();
            }
        };
        this.h = new BroadcastReceiver() {
            public void onReceive(final Context context, final Intent intent) {
                if (com.tremorvideo.sdk.android.a.b.this.c) {
                    com.tremorvideo.sdk.android.a.b.this.i.d();
                }
            }
        };
    }
    ...
    public void a(final Bundle bundle, final Activity j) {
        Thread.setDefaultUncaughtExceptionHandler((Thread.UncaughtExceptionHandler)new Thread.UncaughtExceptionHandler() {
            ...
            public void uncaughtException(final Thread thread, final Throwable t) {
                ...
                ac.e(t.getMessage());
                com.tremorvideo.sdk.android.a.b.this.j.finish();
            }
        });
        this.j = j;
        this.i = new com.tremorvideo.sdk.android.a.a(this, this.j, com.tremorvideo.sdk.android.a.b.a);
        this.j.requestWindowFeature(1);
        this.j.getWindow().setFlags(1024, 1024);
        this.k = new j((Context)this.j, this);
        final File file = new File(com.tremorvideo.sdk.android.a.b.a.y().h().getAbsolutePath() + "/index.html");
        final Double m = this.m();
        this.k.setPadding(0, 0, 0, 0);
        if (m >= 1.0) {
            final float density = this.j.getResources().getDisplayMetrics().density;
            final LinearLayout$LayoutParams linearLayout$LayoutParams = new LinearLayout$LayoutParams((int)(440 * density), (int)(320 * density));
            ...
            this.k.setInitialScale((int)(density * 100.0f));
            ...
            this.k.setInitialScale((int)(ac.M() * 100.0f));
            (this.e = new Timer()).schedule(new a("file://" + file.getAbsolutePath()), 1000L);
            this.j.setContentView((View)this.k);
        }
        this.l = com.tremorvideo.sdk.android.a.b.b;
    ...
    @Override
    public n g() {
        return com.tremorvideo.sdk.android.a.b.a;
    }
    ...
    class a extends TimerTask
    {
        ...
        @Override
        public void run() {
            com.tremorvideo.sdk.android.a.b.this.e.purge();
            com.tremorvideo.sdk.android.a.b.this.e.cancel();
            com.tremorvideo.sdk.android.a.b.this.e = null;
            com.tremorvideo.sdk.android.a.b.this.j.runOnUiThread((Runnable)new Runnable() {
                @Override
                public void run() {
                    com.tremorvideo.sdk.android.a.b.this.k.loadUrl(com.tremorvideo.sdk.android.a.b.a.this.a);
                }
            });
        }
    }
