...
import android.support.v4.content.AsyncTaskLoader$android.support.v4.content.AsyncTaskLoader$android.support.v4.content.AsyncTaskLoader$LoadTask;
...
public abstract class AsyncTaskLoader<D> extends Loader<D>
{
    ...
    void dispatchOnCancelled(final AsyncTaskLoader$LoadTask asyncTaskLoader$LoadTask, final D n) {
        this.onCanceled(n);
    ...
    void dispatchOnLoadComplete(final AsyncTaskLoader$LoadTask asyncTaskLoader$LoadTask, final D n) {
        if (this.mTask != asyncTaskLoader$LoadTask) {
            this.dispatchOnCancelled((LoadTask)asyncTaskLoader$LoadTask, (Object)n);
            return;
        }
        if (this.isAbandoned()) {
            this.onCanceled(n);
    ...
    final class LoadTask extends ModernAsyncTask<Void, Void, D> implements Runnable
    {
        ...
        protected void onCancelled() {
            try {
                AsyncTaskLoader.this.dispatchOnCancelled(this, (Object)this.result);
            }
            finally {
                this.done.countDown();
            }
        ...
        protected void onPostExecute(final D n) {
            try {
                AsyncTaskLoader.this.dispatchOnLoadComplete(this, (Object)n);
            }
            finally {
                this.done.countDown();
            }
