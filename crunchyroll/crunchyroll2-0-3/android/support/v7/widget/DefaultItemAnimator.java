...
public class DefaultItemAnimator extends ItemAnimator
{
    ...
    private void animateAddImpl(final ViewHolder viewHolder) {
        ...
        animate.alpha(1.0f).setDuration(((RecyclerView.ItemAnimator)this).getAddDuration()).setListener(new VpaListenerAdapter() {
            ...
            public void onAnimationEnd(final View view) {
                ...
                ((RecyclerView.ItemAnimator)DefaultItemAnimator.this).dispatchAddFinished(viewHolder);
            ...
            public void onAnimationStart(final View view) {
                ((RecyclerView.ItemAnimator)DefaultItemAnimator.this).dispatchAddStarting(viewHolder);
            }
        }).start();
    }
        ...
        if (itemView != null) {
            ...
            setDuration.alpha(0.0f).setListener(new VpaListenerAdapter() {
                ...
                public void onAnimationEnd(final View view) {
                    ...
                    ((RecyclerView.ItemAnimator)DefaultItemAnimator.this).dispatchChangeFinished(changeInfo.oldHolder, true);
                ...
                @Override
                public void onAnimationStart(final View view) {
                    ((RecyclerView.ItemAnimator)DefaultItemAnimator.this).dispatchChangeStarting(changeInfo.oldHolder, true);
                }
            }).start();
        }
        if (itemView2 != null) {
            ...
            animate.translationX(0.0f).translationY(0.0f).setDuration(((RecyclerView.ItemAnimator)this).getChangeDuration()).alpha(1.0f).setListener(new VpaListenerAdapter() {
                ...
                public void onAnimationEnd(final View view) {
                    ...
                    ((RecyclerView.ItemAnimator)DefaultItemAnimator.this).dispatchChangeFinished(changeInfo.newHolder, false);
                ...
                @Override
                public void onAnimationStart(final View view) {
                    ((RecyclerView.ItemAnimator)DefaultItemAnimator.this).dispatchChangeStarting(changeInfo.newHolder, false);
                }
            }).start();
        }
    }
    ...
    private void animateMoveImpl(final ViewHolder viewHolder, int n, int n2, final int n3, final int n4) {
        ...
        animate.setDuration(((RecyclerView.ItemAnimator)this).getMoveDuration()).setListener(new VpaListenerAdapter() {
            ...
            public void onAnimationEnd(final View view) {
                animate.setListener(null);
                ((RecyclerView.ItemAnimator)DefaultItemAnimator.this).dispatchMoveFinished(viewHolder);
            ...
            @Override
            public void onAnimationStart(final View view) {
                ((RecyclerView.ItemAnimator)DefaultItemAnimator.this).dispatchMoveStarting(viewHolder);
            }
        }).start();
    }
    ...
    private void animateRemoveImpl(final ViewHolder viewHolder) {
        ...
        animate.setDuration(((RecyclerView.ItemAnimator)this).getRemoveDuration()).alpha(0.0f).setListener(new VpaListenerAdapter() {
            ...
            public void onAnimationEnd(final View view) {
                animate.setListener(null);
                ViewCompat.setAlpha(view, 1.0f);
                ((RecyclerView.ItemAnimator)DefaultItemAnimator.this).dispatchRemoveFinished(viewHolder);
            ...
            @Override
            public void onAnimationStart(final View view) {
                ((RecyclerView.ItemAnimator)DefaultItemAnimator.this).dispatchRemoveStarting(viewHolder);
            }
        }).start();
    }
    ...
    private boolean endChangeAnimationIfNecessary(final ChangeInfo changeInfo, final ViewHolder viewHolder) {
        ...
        ((RecyclerView.ItemAnimator)this).dispatchChangeFinished(viewHolder, b);
        return true;
    }
    ...
    public boolean animateMove(final ViewHolder viewHolder, int n, int n2, final int n3, final int n4) {
        ...
        final int n6 = n4 - n2;
        if (n5 == 0 && n6 == 0) {
            ((RecyclerView.ItemAnimator)this).dispatchMoveFinished(viewHolder);
            return false;
        }
        if (n5 != 0) {
    ...
    public void endAnimation(final ViewHolder viewHolder) {
        ...
        if (this.mPendingRemovals.remove(viewHolder)) {
            ...
            ((RecyclerView.ItemAnimator)this).dispatchRemoveFinished(viewHolder);
        }
        if (this.mPendingAdditions.remove(viewHolder)) {
            ViewCompat.setAlpha(itemView, 1.0f);
            ((RecyclerView.ItemAnimator)this).dispatchAddFinished(viewHolder);
        }
    ...
    public void endAnimations() {
        for (int i = this.mPendingMoves.size() - 1; i >= 0; --i) {
            ...
            ViewCompat.setTranslationY(itemView, 0.0f);
            ViewCompat.setTranslationX(itemView, 0.0f);
            ((RecyclerView.ItemAnimator)this).dispatchMoveFinished(moveInfo.holder);
            this.mPendingMoves.remove(i);
        }
        for (int j = this.mPendingRemovals.size() - 1; j >= 0; --j) {
            ((RecyclerView.ItemAnimator)this).dispatchRemoveFinished(this.mPendingRemovals.get(j));
        ...
        for (int n = this.mMovesList.size() - 1; n >= 0; --n) {
            ...
            for (int n2 = list.size() - 1; n2 >= 0; --n2) {
                ...
                ViewCompat.setTranslationY(itemView2, 0.0f);
                ViewCompat.setTranslationX(itemView2, 0.0f);
                ((RecyclerView.ItemAnimator)this).dispatchMoveFinished(moveInfo2.holder);
                list.remove(n2);
                if (list.isEmpty()) {
        ...
        for (int n3 = this.mAdditionsList.size() - 1; n3 >= 0; --n3) {
            ...
            for (int n4 = list2.size() - 1; n4 >= 0; --n4) {
                ...
                ((RecyclerView.ItemAnimator)this).dispatchAddFinished(viewHolder2);
                list2.remove(n4);
                if (list2.isEmpty()) {
