...
public class RecyclerView extends ViewGroup implements NestedScrollingChild, ScrollingView
{
    ...
    static /* synthetic */ boolean access$2900(final RecyclerView recyclerView) {
        return recyclerView.awakenScrollBars();
    }
    
    static /* synthetic */ void access$4500(final RecyclerView recyclerView, final int n, final int n2) {
        recyclerView.setMeasuredDimension(n, n2);
    }
    
    static /* synthetic */ void access$800(final RecyclerView recyclerView, final View view, final int n, final ViewGroup$LayoutParams viewGroup$LayoutParams) {
        recyclerView.attachViewToParent(view, n, viewGroup$LayoutParams);
    }
    
    static /* synthetic */ void access$900(final RecyclerView recyclerView, final int n) {
    ...
    private void animateAppearance(final ViewHolder viewHolder, final Rect rect, final int n, final int n2) {
        final View itemView = viewHolder.itemView;
        if (rect != null && (rect.left != n || rect.top != n2)) {
            viewHolder.setIsRecyclable(false);
            if (this.mItemAnimator.animateMove(viewHolder, rect.left, rect.top, n, n2)) {
    ...
    private void animateChange(final ViewHolder mShadowingHolder, final ViewHolder mShadowedHolder) {
    ...
    private void animateDisappearance(final ItemHolderInfo itemHolderInfo) {
        final View itemView = itemHolderInfo.holder.itemView;
        this.addAnimatingView(itemHolderInfo.holder);
        ...
        if (left != left2 || top != top2) {
            ...
            if (this.mItemAnimator.animateMove(itemHolderInfo.holder, left, top, left2, top2)) {
                this.postAnimationRunner();
            }
        }
        else {
    ...
    private void dispatchContentChangedIfNecessary() {
        ...
        if (mEatenAccessibilityChangeFlags != 0 && this.mAccessibilityManager != null && this.mAccessibilityManager.isEnabled()) {
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper((ChildHelper.Callback)new ChildHelper.Callback() {
            ...
            public void attachViewToParent(final View view, final int n, final ViewGroup$LayoutParams viewGroup$LayoutParams) {
                ...
                RecyclerView.access$800(RecyclerView.this, view, n, viewGroup$LayoutParams);
            }
            ...
            public void detachViewFromParent(final int n) {
                ...
                RecyclerView.access$900(RecyclerView.this, n);
            }
    ...
    private void processDisappearingList(final ArrayMap<View, Rect> arrayMap) {
        final List<View> mDisappearingViewsInLayoutPass = this.mState.mDisappearingViewsInLayoutPass;
        for (int i = mDisappearingViewsInLayoutPass.size() - 1; i >= 0; --i) {
            final View view = mDisappearingViewsInLayoutPass.get(i);
            final ViewHolder childViewHolderInt = getChildViewHolderInt(view);
            final ItemHolderInfo itemHolderInfo = this.mState.mPreLayoutHolderMap.remove(childViewHolderInt);
            ...
            if (arrayMap.remove(view) != null) {
                ...
                this.animateDisappearance(itemHolderInfo);
            }
            else {
                this.animateDisappearance(new ItemHolderInfo(childViewHolderInt, view.getLeft(), view.getTop(), view.getRight(), view.getBottom()));
            }
        }
    ...
    void assertInLayoutOrScroll(final String s) {
        if (this.isRunningLayoutOrScroll()) {
            return;
        }
        if (s == null) {
    ...
    void dispatchLayout() {
        if (this.mAdapter == null) {
            ...
            if (this.mState.mRunSimpleAnimations && this.mItemsChanged && this.supportsChangeAnimations()) {
                mOldChangedHolders = new ArrayMap<Long, ViewHolder>();
            }
            else {
            ...
            this.mItemsChanged = false;
            this.mItemsAddedOrRemoved = false;
            final SimpleArrayMap<Object, Object> simpleArrayMap = null;
            ...
            if (this.mState.mRunSimpleAnimations) {
                ...
                for (int childCount = this.mChildHelper.getChildCount(), i = 0; i < childCount; ++i) {
                    ...
                    if (!childViewHolderInt.shouldIgnore() && (!childViewHolderInt.isInvalid() || this.mAdapter.hasStableIds())) {
                        ...
                        this.mState.mPreLayoutHolderMap.put(childViewHolderInt, new ItemHolderInfo(childViewHolderInt, itemView.getLeft(), itemView.getTop(), itemView.getRight(), itemView.getBottom()));
                    }
                }
            }
            SimpleArrayMap<Object, Object> simpleArrayMap2;
            if (this.mState.mRunPredictiveAnimations) {
                ...
                simpleArrayMap2 = (SimpleArrayMap<Object, Object>)new ArrayMap<Object, Rect>();
                for (int k = 0; k < this.mChildHelper.getChildCount(); ++k) {
                    ...
                    if (!getChildViewHolderInt(child).shouldIgnore()) {
                        ...
                        while (true) {
                            b2 = b;
                            if (n >= this.mState.mPreLayoutHolderMap.size()) {
                                break;
                            }
                            if (((ViewHolder)this.mState.mPreLayoutHolderMap.keyAt(n)).itemView == child) {
                                b2 = true;
                                break;
                            }
                            ++n;
                        ...
                        if (!b2) {
                            simpleArrayMap2.put(child, new Rect(child.getLeft(), child.getTop(), child.getRight(), child.getBottom()));
                        }
                    }
                }
                ...
                if (this.mState.mOldChangedHolders != null) {
                    final int childCount3 = this.mChildHelper.getChildCount();
                    int n2 = 0;
                    while (true) {
                        simpleArrayMap2 = simpleArrayMap;
                        if (n2 >= childCount3) {
                        ...
                        final ViewHolder childViewHolderInt3 = getChildViewHolderInt(this.mChildHelper.getChildAt(n2));
            ...
            if (this.mState.mRunSimpleAnimations) {
                SimpleArrayMap<Long, ViewHolder> simpleArrayMap3;
                if (this.mState.mOldChangedHolders != null) {
                    simpleArrayMap3 = new ArrayMap<Long, ViewHolder>();
                }
                else {
                    simpleArrayMap3 = null;
                }
                for (int childCount4 = this.mChildHelper.getChildCount(), l = 0; l < childCount4; ++l) {
                    final ViewHolder childViewHolderInt4 = getChildViewHolderInt(this.mChildHelper.getChildAt(l));
                    if (!childViewHolderInt4.shouldIgnore()) {
                        ...
                        if (simpleArrayMap3 != null && this.mState.mOldChangedHolders.get(changedHolderKey) != null) {
                            simpleArrayMap3.put(changedHolderKey, childViewHolderInt4);
                        }
                        else {
                            this.mState.mPostLayoutHolderMap.put(childViewHolderInt4, new ItemHolderInfo(childViewHolderInt4, itemView2.getLeft(), itemView2.getTop(), itemView2.getRight(), itemView2.getBottom()));
                        }
                    }
                }
                this.processDisappearingList((ArrayMap<View, Rect>)simpleArrayMap2);
                for (int n3 = this.mState.mPreLayoutHolderMap.size() - 1; n3 >= 0; --n3) {
                    if (!this.mState.mPostLayoutHolderMap.containsKey(this.mState.mPreLayoutHolderMap.keyAt(n3))) {
                        final ItemHolderInfo itemHolderInfo = this.mState.mPreLayoutHolderMap.valueAt(n3);
                        this.mState.mPreLayoutHolderMap.removeAt(n3);
                        final View itemView3 = itemHolderInfo.holder.itemView;
                ...
                if (size > 0) {
                    for (int n4 = size - 1; n4 >= 0; --n4) {
                        final ViewHolder viewHolder = this.mState.mPostLayoutHolderMap.keyAt(n4);
                        final ItemHolderInfo itemHolderInfo2 = this.mState.mPostLayoutHolderMap.valueAt(n4);
                        if (this.mState.mPreLayoutHolderMap.isEmpty() || !this.mState.mPreLayoutHolderMap.containsKey(viewHolder)) {
                            this.mState.mPostLayoutHolderMap.removeAt(n4);
                            Rect rect;
                            if (simpleArrayMap2 != null) {
                                rect = simpleArrayMap2.get(viewHolder.itemView);
                            }
                            else {
                                rect = null;
                            }
                            this.animateAppearance(viewHolder, rect, itemHolderInfo2.left, itemHolderInfo2.top);
                        }
                    }
                }
                for (int size2 = this.mState.mPostLayoutHolderMap.size(), n5 = 0; n5 < size2; ++n5) {
                    final ViewHolder viewHolder2 = this.mState.mPostLayoutHolderMap.keyAt(n5);
                    final ItemHolderInfo itemHolderInfo3 = this.mState.mPostLayoutHolderMap.valueAt(n5);
                    final ItemHolderInfo itemHolderInfo4 = this.mState.mPreLayoutHolderMap.get(viewHolder2);
                    if (itemHolderInfo4 != null && itemHolderInfo3 != null && (itemHolderInfo4.left != itemHolderInfo3.left || itemHolderInfo4.top != itemHolderInfo3.top)) {
                        ...
                        if (this.mItemAnimator.animateMove(viewHolder2, itemHolderInfo4.left, itemHolderInfo4.top, itemHolderInfo3.left, itemHolderInfo3.top)) {
                            this.postAnimationRunner();
                        }
                    }
                }
                ...
                for (int n6 = size3 - 1; n6 >= 0; --n6) {
                    final long longValue = this.mState.mOldChangedHolders.keyAt(n6);
                    final ViewHolder viewHolder3 = this.mState.mOldChangedHolders.get(longValue);
                    final View itemView4 = viewHolder3.itemView;
                    if (!viewHolder3.shouldIgnore() && this.mRecycler.mChangedScrap != null && this.mRecycler.mChangedScrap.contains(viewHolder3)) {
                        this.animateChange(viewHolder3, simpleArrayMap3.get(longValue));
                    }
                }
            }
            this.resumeRequestLayout(false);
    ...
    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper((AdapterHelper.Callback)new AdapterHelper.Callback() {
            ...
            public void markViewHoldersUpdated(final int n, final int n2) {
                RecyclerView.this.viewRangeUpdate(n, n2);
            ...
            public void offsetPositionsForRemovingInvisible(final int n, final int n2) {
                ...
                RecyclerView.this.mItemsAddedOrRemoved = true;
                State.access$1012(RecyclerView.this.mState, n2);
            }
    ...
    public boolean onGenericMotionEvent(final MotionEvent motionEvent) {
        if (this.mLayout != null && (MotionEventCompat.getSource(motionEvent) & 0x2) != 0x0 && motionEvent.getAction() == 8) {
            float axisValue;
            if (this.mLayout.canScrollVertically()) {
                axisValue = MotionEventCompat.getAxisValue(motionEvent, 9);
            }
            else {
                axisValue = 0.0f;
            }
            float axisValue2;
            if (this.mLayout.canScrollHorizontally()) {
                axisValue2 = MotionEventCompat.getAxisValue(motionEvent, 10);
            }
            else {
                axisValue2 = 0.0f;
            }
            if (axisValue != 0.0f || axisValue2 != 0.0f) {
                ...
                this.scrollBy((int)(axisValue2 * scrollFactor), (int)(axisValue * scrollFactor));
                return false;
            }
        }
        return false;
    ...
    public boolean onTouchEvent(final MotionEvent motionEvent) {
        ...
        switch (actionMasked) {
            ...
            case 2: {
                ...
                final int n7 = (int)(MotionEventCompat.getX(motionEvent, pointerIndex) + 0.5f);
                final int n8 = (int)(MotionEventCompat.getY(motionEvent, pointerIndex) + 0.5f);
                final int n9 = this.mLastTouchX - n7;
                final int n10 = this.mLastTouchY - n8;
                int n11 = n9;
                int n12 = n10;
                if (this.dispatchNestedPreScroll(n9, n10, this.mScrollConsumed, this.mScrollOffset)) {
                    n11 = n9 - this.mScrollConsumed[0];
                    n12 = n10 - this.mScrollConsumed[1];
                ...
                if (this.mScrollState != 1) {
                    ...
                    if (canScrollVertically) {
                        n16 = n12;
                        b3 = b2;
                        if (Math.abs(n12) > this.mTouchSlop) {
                            if (n12 > 0) {
                                n16 = n12 - this.mTouchSlop;
                            }
                            else {
                                n16 = n12 + this.mTouchSlop;
                            }
                ...
                if (this.scrollByInternal(n13, n14, obtain)) {
                    this.getParent().requestDisallowInterceptTouchEvent(true);
                    break;
                }
                break;
            ...
            case 1: {
                ...
                float n17;
                if (canScrollHorizontally) {
                    n17 = -VelocityTrackerCompat.getXVelocity(this.mVelocityTracker, this.mScrollPointerId);
                }
                else {
                    n17 = 0.0f;
                }
                float n18;
                if (canScrollVertically) {
                    n18 = -VelocityTrackerCompat.getYVelocity(this.mVelocityTracker, this.mScrollPointerId);
                }
                else {
                    n18 = 0.0f;
                }
                if ((n17 == 0.0f && n18 == 0.0f) || !this.fling((int)n17, (int)n18)) {
                    this.setScrollState(0);
                }
                this.mVelocityTracker.clear();
                this.releaseGlows();
    ...
    static class AdapterDataObservable extends Observable<AdapterDataObserver>
    {
        ...
        public void notifyItemRangeChanged(final int n, final int n2) {
            for (int i = this.mObservers.size() - 1; i >= 0; --i) {
                ((AdapterDataObserver)this.mObservers.get(i)).onItemRangeChanged(n, n2);
            }
        }
    ...
    public abstract static class ItemAnimator
    {
        ...
        {
            void onAddFinished(final ViewHolder p0);
            
            void onChangeFinished(final ViewHolder p0);
            
            void onMoveFinished(final ViewHolder p0);
            
            void onRemoveFinished(final ViewHolder p0);
        }
    }
    ...
    private class ItemAnimatorRestoreListener implements ItemAnimatorListener
    {
        ...
        @Override
        public void onChangeFinished(final ViewHolder viewHolder) {
            viewHolder.setIsRecyclable(true);
    ...
    private static class ItemHolderInfo
    {
        ...
        ItemHolderInfo(final ViewHolder holder, final int left, final int top, final int right, final int bottom) {
            this.holder = holder;
            this.left = left;
            this.top = top;
            this.right = right;
    ...
    public abstract static class LayoutManager
    {
        ...
        public boolean onRequestChildFocus(final RecyclerView recyclerView, final View view, final View view2) {
            return this.isSmoothScrolling() || recyclerView.isRunningLayoutOrScroll();
        }
    ...
    public final class Recycler
    {
        ...
        ViewHolder getScrapViewForPosition(final int n, int i, final boolean b) {
            ...
            while (j < size) {
                ...
                if (!viewHolder.wasReturnedFromScrap() && viewHolder.getLayoutPosition() == n && !viewHolder.isInvalid() && (RecyclerView.this.mState.mInPreLayout || !viewHolder.isRemoved())) {
                    if (i != -1 && viewHolder.getItemViewType() != i) {
                        Log.e("RecyclerView", "Scrap view for position " + n + " isn't dirty but has" + " wrong view type! (found " + viewHolder.getItemViewType() + " but expected " + i + ")");
                        break;
                    }
                    viewHolder.addFlags(32);
                    return viewHolder;
            ...
            if (!b) {
                final View hiddenNonRemovedView = RecyclerView.this.mChildHelper.findHiddenNonRemovedView(n, i);
                if (hiddenNonRemovedView != null) {
                    RecyclerView.this.mItemAnimator.endAnimation(RecyclerView.this.getChildViewHolder(hiddenNonRemovedView));
                }
            }
            int size2;
            ViewHolder viewHolder2;
            for (size2 = this.mCachedViews.size(), i = 0; i < size2; ++i) {
                viewHolder2 = this.mCachedViews.get(i);
                if (!viewHolder2.isInvalid() && viewHolder2.getLayoutPosition() == n) {
                    if (!b) {
        ...
        View getViewForPosition(final int n, final boolean b) {
            ...
            layoutParams2.mPendingInvalidate = (b5 && b7 && b2);
        ...
        void recycleViewHolderInternal(final ViewHolder viewHolder) {
            ...
            final boolean access$4000 = viewHolder.doesTransientStatePreventRecycling();
            int n;
            if (RecyclerView.this.mAdapter != null && access$4000 && RecyclerView.this.mAdapter.onFailedToRecycleView(viewHolder)) {
                n = 1;
            }
            else {
                n = 0;
    ...
    private class RecyclerViewDataObserver extends AdapterDataObserver
    {
        ...
        public void onItemRangeChanged(final int n, final int n2) {
            RecyclerView.this.assertNotInLayoutOrScroll(null);
            if (RecyclerView.this.mAdapterHelper.onItemRangeChanged(n, n2)) {
    ...
    public static class State
    {
        ...
        public State() {
            this.mTargetPosition = -1;
            this.mPreLayoutHolderMap = new ArrayMap<ViewHolder, ItemHolderInfo>();
            this.mPostLayoutHolderMap = new ArrayMap<ViewHolder, ItemHolderInfo>();
            this.mOldChangedHolders = new ArrayMap<Long, ViewHolder>();
        ...
        static /* synthetic */ int access$1012(final State state, int mDeletedInvisibleItemCountSincePreviousLayout) {
        ...
        private void removeFrom(final ArrayMap<Long, ViewHolder> arrayMap, final ViewHolder viewHolder) {
        ...
        public void onViewIgnored(final ViewHolder viewHolder) {
            this.onViewRecycled(viewHolder);
        }
        
        void onViewRecycled(final ViewHolder viewHolder) {
            this.mPreLayoutHolderMap.remove(viewHolder);
            this.mPostLayoutHolderMap.remove(viewHolder);
            if (this.mOldChangedHolders != null) {
                this.removeFrom(this.mOldChangedHolders, viewHolder);
            }
        ...
        public void run() {
            ...
            if (mScroller.computeScrollOffset()) {
                ...
                if (RecyclerView.this.mAdapter != null) {
                    ...
                    int n10 = n9;
                    int scrollVerticallyBy = n5;
                    if (n2 != 0) {
                        scrollVerticallyBy = RecyclerView.this.mLayout.scrollVerticallyBy(n2, RecyclerView.this.mRecycler, RecyclerView.this.mState);
                        n10 = n2 - scrollVerticallyBy;
                    }
                    TraceCompat.endSection();
                    if (RecyclerView.this.supportsChangeAnimations()) {
                        for (int childCount = RecyclerView.this.mChildHelper.getChildCount(), i = 0; i < childCount; ++i) {
                            final View child = RecyclerView.this.mChildHelper.getChildAt(i);
                            final ViewHolder childViewHolder = RecyclerView.this.getChildViewHolder(child);
                            if (childViewHolder != null && childViewHolder.mShadowingHolder != null) {
                    ...
                    if (mSmoothScroller != null && !mSmoothScroller.isPendingInitialRun() && mSmoothScroller.isRunning()) {
                        ...
                        if (itemCount == 0) {
                            ...
                            mSmoothScroller.onAnimation(n - n7, n2 - n10);
                        }
                        else {
                            mSmoothScroller.onAnimation(n - n7, n2 - n10);
                        }
                ...
                if (!RecyclerView.access$2900(RecyclerView.this)) {
                    RecyclerView.this.invalidate();
                }
                boolean b;
    ...
    public abstract static class ViewHolder
    {
        ...
        void setScrapContainer(final Recycler mScrapContainer) {
