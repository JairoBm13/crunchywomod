...
public final class MediaRouter
{
    ...
    public void setMediaSessionCompat(final MediaSessionCompat mediaSessionCompat) {
        if (MediaRouter.DEBUG) {
            Log.d("MediaRouter", "addMediaSessionCompat: " + mediaSessionCompat);
        }
        MediaRouter.sGlobal.setMediaSessionCompat(mediaSessionCompat);
    }
    ...
    private static final class GlobalMediaRouter implements RegisteredMediaRouteProviderWatcher.Callback, SyncCallback
    {
        ...
        GlobalMediaRouter(final Context mApplicationContext) {
            ...
            this.mSessionActiveListener = new MediaSessionCompat.OnActiveChangeListener() {
                @Override
        ...
        private void setSelectedRouteInternal(final RouteInfo mSelectedRoute, final int n) {
                    ...
                    if (mediaRouteProviderDescriptor.isValid()) {
                        ...
                        while (i < size) {
                            ...
                            if (routeByDescriptorId < 0) {
                                ...
                                final ArrayList access$700 = providerInfo.mRoutes;
                                final int n3 = n2 + 1;
                                access$700.add(n2, routeInfo);
                                ...
                                final ArrayList access$701 = providerInfo.mRoutes;
                                final int n4 = n2 + 1;
        ...
        public void selectRoute(final RouteInfo routeInfo, final int n) {
            ...
            this.setSelectedRouteInternal(routeInfo, n);
        }
        ...
        public void setMediaSessionCompat(final MediaSessionCompat mediaSessionCompat) {
            ...
            if (Build$VERSION.SDK_INT >= 21) {
                ...
                if (mediaSessionCompat != null) {
                    mediaSession = mediaSessionCompat.getMediaSession();
                }
                else {
                    mediaSession = null;
                }
                ...
                if ((this.mRccMediaSession = mediaSessionCompat) != null) {
                    mediaSessionCompat.addOnActiveChangeListener(this.mSessionActiveListener);
                    if (mediaSessionCompat.isActive()) {
                        this.addRemoteControlClient(mediaSessionCompat.getRemoteControlClient());
                    }
                }
            }
        }
        ...
        private final class MediaSessionRecord
        {
            ...
            public MediaSessionRecord(final Object o) {
                this.mMsCompat = MediaSessionCompat.obtain(GlobalMediaRouter.this.mApplicationContext, o);
            }
            ...
            public void configureVolume(final int n, final int n2, final int currentVolume) {
                ...
                this.mVpCompat = new VolumeProviderCompat(n, n2, currentVolume) {
                    ...
                    public void onAdjustVolume(final int n) {
                        GlobalMediaRouter.this.mCallbackHandler.post((Runnable)new Runnable() {
                            @Override
                            public void run() {
