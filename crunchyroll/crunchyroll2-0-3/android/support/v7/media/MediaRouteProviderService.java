...
public abstract class MediaRouteProviderService extends Service
{
    ...
    private boolean onUnselectRoute(final Messenger messenger, final int n, final int n2, final int n3) {
        final ClientRecord client = this.getClient(messenger);
        if (client != null) {
            final MediaRouteProvider.RouteController routeController = client.getRouteController(n2);
            if (routeController != null) {
                routeController.onUnselect(n3);
                if (MediaRouteProviderService.DEBUG) {
                ...
                switch (n) {
                    ...
                    case 6: {
                        if (bundle == null) {
                            ...
                            n = bundle.getInt("unselectReason", 0);
                        }
                        return mediaRouteProviderService.onUnselectRoute(messenger, n2, n3, n);
                    }
                    case 7: {
