...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent
{
    ...
    static Behavior parseBehavior(final Context context, final AttributeSet set, String s) {
        ...
        Label_0146: {
            ...
            try {
                // iftrue(Label_0158:, s.indexOf(46) < 0)
                while (true) {
        ...
        while (true) {
            ...
            if ((b || n != 0) && actionMasked != 0) {
                ...
                if (!b) {
                    b2 = b;
                    if (behavior != null) {
                        final boolean onInterceptTouchEvent = behavior.onInterceptTouchEvent(this, mBehaviorTouchView, motionEvent);
                        if (b2 = onInterceptTouchEvent) {
                            this.mBehaviorTouchView = mBehaviorTouchView;
                            b2 = onInterceptTouchEvent;
                        }
                    }
                }
    ...
    private void prepareChildren() {
        ...
        int n3 = n;
        int n4;
        for (int i = n2; i < childCount; ++i, n3 = n4) {
            final View child = this.getChildAt(i);
    ...
    public boolean onTouchEvent(MotionEvent obtain) {
        ...
        Label_0074: {
            if (this.mBehaviorTouchView == null) {
                performIntercept = this.performIntercept(obtain);
                if (!(b2 = performIntercept)) {
                    break Label_0074;
                }
            }
            final Behavior behavior = ((LayoutParams)this.mBehaviorTouchView.getLayoutParams()).getBehavior();
        ...
        boolean b3;
        if (this.mBehaviorTouchView == null) {
            b3 = (false | super.onTouchEvent(obtain));
            obtain = motionEvent2;
        }
        else {
            obtain = motionEvent2;
