...
class CircularBorderDrawable extends Drawable
{
    ...
    private Shader createGradientShader() {
        ...
        return (Shader)new LinearGradient(0.0f, (float)mRect.top, 0.0f, (float)mRect.bottom, new int[] { this.mTopOuterStrokeColor, this.mTopInnerStrokeColor, ColorUtils.setAlphaComponent(this.mTopInnerStrokeColor, 0), ColorUtils.setAlphaComponent(this.mBottomInnerStrokeColor, 0), this.mBottomInnerStrokeColor, this.mBottomOuterStrokeColor }, new float[] { 0.0f, n, 0.5f, 0.5f, 1.0f - n, 1.0f }, Shader$TileMode.CLAMP);
    }
