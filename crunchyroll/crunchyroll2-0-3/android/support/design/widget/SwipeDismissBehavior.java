    ...
    public SwipeDismissBehavior() {
        ...
        this.mDragCallback = new ViewDragHelper.Callback() {
            ...
            public void onViewPositionChanged(final View view, final int n, final int n2, final int n3, final int n4) {
                final float n5 = view.getWidth() * SwipeDismissBehavior.this.mAlphaStartSwipeDistance;
                final float n6 = view.getWidth() * SwipeDismissBehavior.this.mAlphaEndSwipeDistance;
                if (n <= n5) {
