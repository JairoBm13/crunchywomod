...
public abstract class RoboPreferenceActivity extends PreferenceActivity implements RoboContext
{
    ...
    protected void onCreate(final Bundle bundle) {
        ...
        this.preferenceListener = injector.getInstance(PreferenceListener.class);
    ...
    public void setPreferenceScreen(PreferenceScreen preferenceScreen) {
        ...
        preferenceScreen = (PreferenceScreen)RoboGuice.getInjector((Context)this).getInstance(ContextScope.class);
        synchronized (ContextScope.class) {
            ((ContextScope)preferenceScreen).enter((Context)this);
            try {
                this.preferenceListener.injectPreferenceViews();
            }
            finally {
                ((ContextScope)preferenceScreen).exit((Context)this);
            }
        }
    }
}
